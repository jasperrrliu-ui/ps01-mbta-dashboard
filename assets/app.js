...
async function main() {
  ...
  function renderMap() {
   const positions = {
      ...
      "Andrew": { point: [70.6, 58.3] }, "Broadway": { point: [70.6, 54.5] }, "South Station": { point: [65.2, 44.4] }, "Downtown Crossing": { point: [63.7, 41.5] }, "State": { point: [64.9, 36.5] }, "Charles/MGH": { point: [47.6, 32.8] }, "Kendall/MIT": { point: [51.3, 35.4] }, "Alewife": { point: [34.7, 14.2] }, "Airport": { point: [81.4, 28.3] }, "Ashmont": { point: [66.5, 80.2] }
   };
